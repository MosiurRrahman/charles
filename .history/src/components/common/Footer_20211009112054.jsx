...
import footerIMG1 from "../../assets/images/blog/1.jpg";
import footerIMG2 from "../../assets/images/blog/2.jpg";
                ...
                <div className="col-xl-4 col-lg-3 col-sm-6 footer-recent-post">
                  ...
                  <ul>
                    <li className="clearfix">
                      <img src={footerIMG1} alt="" className="float-left" />
                    ...
                    <li className="clearfix">
                      <img src={footerIMG2} alt="" className="float-left" />
                      <div className="post float-left">
                        <a href="blog-details.html">
