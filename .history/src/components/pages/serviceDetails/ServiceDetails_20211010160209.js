              ...
              <div className="service-content">
                ...
                <div className="presentation-section">
                  ...
                  <div className="row">
                    ...
                    <div className="col-md-6 col-12"><img src="images/home/pattern3.png" alt="" className="chart" /></div>
                  </div>
                ...
                <div className="market-growth">
                  ...
                  <div className="wrapper">
                    <div className="row">
                      <div className="col-xl-6 col-md-5 col-12"><img src="images/home/21.jpg" alt="" /></div>
            ...
            <div className="col-xl-3 col-lg-4 col-md-6 col-sm-8 col-12 theme-sidebar-one">
              <div className="sidebar-box service-categories">
                ...
                <ul>
                  ...
                  <li className="active"><a href="#">Business Services</a></li>
              ...
              <div className="sidebar-box sidebar-brochures">
                ...
                <ul>
                  <li><a href="#"><i className="fa fa-file-pdf-o" aria-hidden="true" /> Download file. pdf</a></li>
                  <li><a href="#"><i className="fa fa-file-powerpoint-o" aria-hidden="true" /> Download file. ppt</a></li>
                </ul>
