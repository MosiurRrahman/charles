        ...
        <div className="col-lg-3 col-md-4 col-6">
          <div className="single-product">
            ...
            <div className="product-name">
              ...
              <div className="add-to-cart"><a href="shop-details.html"><i className="fa fa-shopping-cart" aria-hidden="true" /> ADD TO CART</a></div>
            </div>
          </div> {/* /.single-product */}
        </div> {/* /.col- */}
        <div className="col-lg-3 col-md-4 col-6">
        ...
        <div className="col-lg-3 col-md-4 col-6">
          <div className="single-product">
            ...
            <div className="product-name">
              ...
              <div className="price"><del>$36.00 </del> $32.70</div>
              <div className="add-to-cart"><a href="shop-details.html"><i className="fa fa-shopping-cart" aria-hidden="true" /> ADD TO CART</a></div>
            </div>
          </div> {/* /.single-product */}
        </div> {/* /.col- */}
        ...
        <div className="col-lg-3 col-md-4 col-6">
          <div className="single-product">
            ...
            <div className="product-name">
              ...
              <div className="price"><del>$43.00 </del>$40.00</div>
              <div className="add-to-cart"><a href="shop-details.html"><i className="fa fa-shopping-cart" aria-hidden="true" /> ADD TO CART</a></div>
            </div>
          </div> {/* /.single-product */}
        </div> {/* /.col- */}
        ...
        <div className="col-lg-3 col-md-4 col-6">
          <div className="single-product">
            ...
            <div className="product-name">
              ...
              <div className="price"><del>$43.00</del>$38.00</div>
              <div className="add-to-cart"><a href="shop-details.html"><i className="fa fa-shopping-cart" aria-hidden="true" /> ADD TO CART</a></div>
            </div>
          </div> {/* /.single-product */}
        </div> {/* /.col- */}
